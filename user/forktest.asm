...
forktest(void)
{
  ...
  36:	3f650513          	addi	a0,a0,1014 # 428 <thread_join+0x8>
  ...
  58:	42450513          	addi	a0,a0,1060 # 478 <thread_join+0x58>
  ...
  6e:	3ce50513          	addi	a0,a0,974 # 438 <thread_join+0x18>
  ...
  80:	3d450513          	addi	a0,a0,980 # 450 <thread_join+0x30>
  ...
  b0:	3bc50513          	addi	a0,a0,956 # 468 <thread_join+0x48>
...
0000000000000410 <thread_create>:
